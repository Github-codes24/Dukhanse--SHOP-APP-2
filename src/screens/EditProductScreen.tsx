...
const EditProductScreen: React.FC<{ navigation?: any }> = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={{ paddingBottom: 32 }}>
        ...
        <Text style={styles.photoLabel}>Product Photo (Front Side)</Text>
        <TouchableOpacity
        ...
        >
          <View style={styles.uploadContent}>
            ...
            <Text style={styles.uploadText}>Upload Product Photo{'\n'}(Front Side)</Text>
          </View>
        </TouchableOpacity>
        {frontImg && (
        ...
        <Text style={styles.photoLabel}>Product Photo (Back Side)</Text>
        <TouchableOpacity
          style={styles.imageUploadCard}
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#fff', margin: 0, marginTop: 29 },
  headerRow: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingVertical: 22,
